...
- [Set up your repository files](https://github.com/jhudsl/OTTR_Template/wiki/Setting-up-your-repository-files)
- [Set up your repository settings](https://github.com/jhudsl/OTTR_Template/wiki/Setting-up-your-repository-settings)
- [Set up GitHub secrets (*outside JHU users only*)](https://github.com/jhudsl/OTTR_Template/wiki/Setting-up-GitHub-secrets)
- [Adding content](https://github.com/jhudsl/OTTR_Template/wiki/Adding-content-to-a-course)
- [About pull request review](https://github.com/jhudsl/OTTR_Template/wiki/About-pull-request-review)
